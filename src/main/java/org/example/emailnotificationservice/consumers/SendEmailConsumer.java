...
import org.example.emailnotificationservice.dtos.SendEmailMessageDto;

import org.example.emailnotificationservice.utils.EmailUtils;
    ...
    public void handleSendEmail(String message) throws JsonProcessingException {
        ...
        Authenticator auth = new Authenticator() {
            ...
            protected PasswordAuthentication getPasswordAuthentication() {
                return new PasswordAuthentication("demoemailscaler@gmail.com", "");
            }
        };
